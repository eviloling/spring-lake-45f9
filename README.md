...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/spring-lake-45f9
```

A live public deployment of this template is available at [https://spring-lake-45f9.templates.workers.dev](https://spring-lake-45f9.templates.workers.dev)
